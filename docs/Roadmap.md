...
- [x] Project setup
  ...
  - [x] Add dependencies (gRPC, protobuf)
- [x] Core components
  - [x] Server key generation and storage
  - [x] User registration and authentication (demo password hashing)
  - [x] Message storage (SQLite)
  - [x] gRPC server setup
- [x] Federation
  - [x] Server discovery (well-known HTTP endpoint)
  - [ ] DNS discovery (planned)
  - [ ] mTLS connection handling (planned)
  - [x] Message delivery API (gRPC)
- [x] Crypto integration
  - [x] NaCl box encryption/decryption helpers
  - [x] Server signing key for key attestations (`signKey`)
  - [ ] Sender-signed message envelopes (planned)

**Client Implementation:**
- [x] Project setup
  - [x] Initialize Go module
  - [x] Basic CLI (interactive + one-shot)
- [x] Core features
  - [x] User encryption key generation (NaCl box / X25519)
  - [x] Account registration
  - [x] Login and authentication (demo tokens)
  - [x] Send message (encrypt + submit)
  - [x] Receive message (fetch + decrypt)
  - [x] First-contact accept flow (`accept`)
- [x] User interface
  - [x] Interactive prompts
  - [x] Message display formatting
  - [x] Basic contact trust management

**Demo Setup:**
- [x] Docker Compose configuration
  - [x] 3 server containers
  - [x] Client container
  - [x] Network configuration
- [x] Configuration files
  - [x] Server configs for each domain
  - [x] Client config templates generated by demo
- [x] Scripts
  - [x] Setup script (initialize servers)
...
**Testing:**
- [ ] Unit tests for crypto functions (planned)
- [x] Integration test for message delivery
- [x] Manual testing of demo scenario
